...
[EntityLabel("Реестр компонентов")]
[Description("Реестр службы компонентов предоставляет инфомарция об зарегистрированных, установленных и активированных компонентах системы. А также их зависимостях.")]
public class ComponentRegistry
{
    public static int Counter = FormsHelper.AddSingletonConfiguration<ComponentRegistry>();
