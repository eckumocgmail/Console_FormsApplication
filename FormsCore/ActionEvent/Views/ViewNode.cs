...
public class ViewNode: ViewPane
{
    ...
    public ViewNode()
    {
        OnRemoved = new EventHandler((sender, evt) => { });
        OnAppended = new EventHandler((sender, evt) => { });
        OnDropped = new EventHandler((sender, evt) => { });
    }
    ...
    public void Append(string name, ViewNode pnode)
    {
    ...
    public void RemoveFromParent()
    {
        ...
        Writing.ToConsole(GetType().Name + " Children Node Removed " + GetHashCode());
        if (this.Parent != null)
        {
    ...
    {
        Writing.ToConsole(GetType().Name + " Children Node Dropped " + GetHashCode());
